...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            requestPermissions(new String[] { android.Manifest.permission.READ_EXTERNAL_STORAGE, android.Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA }, 1);
                                ...
                                public void onClick(DialogInterface dialog, int item) {
                                    if (item == 0) {
                                        ...
                                        ClipboardManager clipboard = (ClipboardManager) getSystemService(
                                                CLIPBOARD_SERVICE);
                                        clipboard.setText(item2);
                                        Toast.makeText(MainActivity.this, getString(R.string.t_cp_ssid),
                                        ...
                                        ClipboardManager clipboard = (ClipboardManager) getSystemService(
                                                CLIPBOARD_SERVICE);
                                        clipboard.setText(item2);
                                        Toast.makeText(MainActivity.this, getString(R.string.t_cp_pwd),
                                                Toast.LENGTH_LONG).show();
                                        ...
                                        try {
                                            ...
                                            Runtime.getRuntime().exec(new String[] { "su", "-c", "mkdir sdcard/WifiViewQR" }).getInputStream();
                                        ...
                                        try {
                                            Runtime.getRuntime().exec(new String[] { "su", "-c", "mv /data/data/com.fast0n.wifiview/cache/qr.png sdcard/WifiViewQR/" + item2 +".png"}).getInputStream();
                                        } catch (IOException e) {
                                            e.printStackTrace();
                                        }
